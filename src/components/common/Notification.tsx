        ...
        <>
            {notificationStore.showNotification && (
                <div aria-live="assertive"
                     className="pointer-events-none fixed inset-0 top-12 z-50 flex items-end px-4 py-6 sm:items-start sm:p-6">
                            ...
                            <div className="p-4">
                                <div className="flex items-start">
                                    ...
                                    <div className="ml-3 w-0 flex-1 pt-0.5">
                                        <p className="text-sm font-medium text-gray-900">{notificationStore.message}</p>
